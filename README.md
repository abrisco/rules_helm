...
HelmPackageInfo(<a href="#HelmPackageInfo-chart">chart</a>, <a href="#HelmPackageInfo-images">images</a>, <a href="#HelmPackageInfo-metadata">metadata</a>, <a href="#HelmPackageInfo-deps">deps</a>)
</pre>
...
| <a id="HelmPackageInfo-deps"></a>deps |  depset[HelmPackageInfo]: A depset of helm chart dependencies that the chart depends on    |

...
func lint(directory string, package_name string, strict bool, helm string, helmPluginsDir string, output string) {
...
func main() {
	...
	lint(dir, lint_dir, args.strict, helm, helmPlugins, args.output)
}
